...
function addUser (nome, login, senha, email, cidade, categoria) {
    
    // Cria um objeto de usuario para o novo usuario 
    let newId = generateUUID ();
    let usuario = { "id": newId, "login": login, "senha": senha, "nome": nome, "email": email, "cidade": cidade, "categoria": categoria };
